  ...
  return (
    <div className='flex flex-col py-5 sm:py-10'>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 my-5 sm:my-10 gap-5 sm:gap-10 text-xs sm:text-sm md:text-base">
         <div className="border p-5 sm:p-7 md:p-10 rounded-4xl shadow-[0_8px_0px_-5px_rgba(0,0,0,0.3)] shadow-black">
            <div className="flex max-[300px]:flex-col gap-5 ">
                <img className="" src="/team1.png" alt='img'/>
                <h1 className="self-baseline-last text-xl "><span className="font-semibold">John Smith</span> <br />
         ...
         <div className="border p-5 sm:p-7 md:p-10 rounded-4xl shadow-[0_8px_0px_-5px_rgba(0,0,0,0.3)] shadow-black">
            <div className="flex max-[300px]:flex-col gap-5 ">
                <img className="" src="/team2.png" alt='img'/>
                <h1 className="self-baseline-last text-xl "><span className="font-semibold">Jane Doe</span> <br />
         ...
         <div className="border p-5 sm:p-7 md:p-10 rounded-4xl shadow-[0_8px_0px_-5px_rgba(0,0,0,0.3)] shadow-black">
            <div className="flex max-[300px]:flex-col gap-5 ">
                <img className="" src="/team3.png" alt='img'/>
                <h1 className="self-baseline-last text-xl "><span className="font-semibold">Michael Brown</span> <br />
         ...
         <div className="border p-5 sm:p-7 md:p-10 rounded-4xl shadow-[0_8px_0px_-5px_rgba(0,0,0,0.3)] shadow-black">
            <div className="flex max-[300px]:flex-col gap-5 ">
                <img className="" src="/team4.png" alt='img'/>
                <h1 className="self-baseline-last text-xl "><span className="font-semibold">Emily Johnson</span> <br />
         ...
         <div className="border p-5 sm:p-7 md:p-10 rounded-4xl shadow-[0_8px_0px_-5px_rgba(0,0,0,0.3)] shadow-black">
            <div className="flex max-[300px]:flex-col gap-5 ">
                <img className="" src="/team5.png" alt='img'/>
                <h1 className="self-baseline-last text-xl "><span className="font-semibold">Brian Williams</span> <br />
         ...
         <div className="border p-5 sm:p-7 md:p-10 rounded-4xl shadow-[0_8px_0px_-5px_rgba(0,0,0,0.3)] shadow-black">
            <div className="flex max-[300px]:flex-col gap-5 ">
                <img className="" src="/team6.png" alt='img'/>
                <h1 className="self-baseline-last text-xl "><span className="font-semibold">Sarah Kim</span> <br />
