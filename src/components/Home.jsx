  ...
  return (
    <div className='flex flex-col sm:flex-row gap-10 mt-[2vw] sm:mt-10'>
        <div className=' w-full sm:w-[40vw] flex items-center'>
            ...
            <button className='py-3 px-3 lg:py-3 lg:px-7 border rounded-xl bg-black text-white hover:bg-white hover:text-black transition-all ease-in w-45'>Book a Consulation</button>
        </div>
        </div>
